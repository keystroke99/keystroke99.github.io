    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/Rohini-Kumar.jpg" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Rohini Kumar D</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Backend Developer - NodeJS+MongoDB</p>
            </div>
        </header>
        <!-- About Section-->
                    ...
                    <div>
                        <ul class="lead">
                            ...
                            <li>Experience interacting with and building web APIs. Experience with
                                RESTful + JSON services.</li>
                            <li>Good Knowledge and managing GIT.</li>
                            <li>Good Knowledge on Deploying the Application into AWS(Amazon Web Services)</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead"><i class="fas fa-envelope"></i> : <b>keystroke99@gmail.com</b></p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead"><i class="fas fa-phone"></i> : <b>+91-8885860111</b></p></div>
                </div>
